...
angular.module('liveCityApp').controller('mainCtrl', ['$scope', function($scope) {
	...
	$scope.update = function(city) {
		$scope.text = 'Rechercher' + city.name;
		city.name = city.name.replace(/\b\w/g, l => l.toUpperCase());
	};

	$scope.visit = function(city) {
		$scope.text = 'Visiter' + city.name;
	};
...
function initMap() {
	var france = {lat: 47.7510112, lng: 2.3148873};
	var paris  = {lat: 48.859489,  lng: 2.320582};
